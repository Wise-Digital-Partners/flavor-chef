        ...
        <div className="container">
          <div className="grid md:grid-cols-2 items-center gap-y-10 md:gap-x-10 lg:gap-x-20">
            <div className="order-2 md:order-1">
              <h1>North County San Diego Catering</h1>
              <p>
                We believe good food, enjoyed by good people, should be
                celebrated. At Flavor Chef Catering, we’re committed to creating
                the best catering experience for your North County San Diego
                event or occasion.
              </p>
              <ButtonSolid
                as="button"
            ...
            <div className="order-1 md:order-2">
              <GatsbyImage
                ...
                alt="North County San Diego Catering"
              />
            </div>
          </div>
        </div>
        ...
        <div className="container relative">
          <header className="max-w-3xl mx-auto text-center mb-12 md:mb-26">
            ...
            <p>
              ...
              extraordinary with our North County San Diego full-service
              catering company, featuring cuisine from top local chefs.
            </p>
          </header>
        </div>
          ...
          <div className="grid md:grid-cols-2 items-center gap-y-10 md:gap-x-10 lg:gap-x-20">
            <div>
              <GatsbyImage
                ...
                alt="North County San Diego’s Caterer of Choice"
              />
            </div>
            <div>
              <h2>North County San Diego’s Caterer of Choice</h2>
              <p>
                From the coastal vibes of cities like Carlsbad and Del Mar to
                the open spaces of inland North County San Diego, we love
                bringing our unique brand of catering services to the region.
                The Flavor Fam team of top chefs has helped create many
                memorable experiences in North County. The possibilities are
