  ...
  return (
    <Layout>
      <SearchEngineOptimization
        title="Downtown San Diego Catering | Flavor Chef Catering"
        description="Make your event unforgettable with Flavor Chef Catering, your full-service Downtown San Diego catering company. Enjoy chef-inspired, local ingredient dishes."
        ...
        <div className="container">
          <div className="grid md:grid-cols-2 items-center gap-y-10 md:gap-x-10 lg:gap-x-20">
            <div className="order-2 md:order-1">
              <h1>Downtown San Diego Catering</h1>
              <p>
                At Flavor Chef Catering, we’re committed to creating the best
                catering experience for your downtown San Diego wedding, social
                event, or special occasion. We combine classic cooking
                techniques with our unique style to give your guests an
            ...
            <div className="order-1 md:order-2">
              <GatsbyImage
                ...
                alt="Downtown San Diego Catering"
              />
            </div>
          </div>
        </div>
        ...
        <div className="container relative">
          <header className="max-w-3xl mx-auto text-center mb-12 md:mb-26">
            ...
            <p>
              ...
              extraordinary with our Downtown San Diego full-service catering
              company, featuring cuisine from top local chefs.
            </p>
          </header>
        </div>
          ...
          <div className="grid md:grid-cols-2 items-center gap-y-10 md:gap-x-10 lg:gap-x-20">
            <div>
              <GatsbyImage
                ...
                alt="Downtown San Diego’s Caterer of Choice"
              />
            </div>
            <div>
              <h2>Downtown San Diego’s Caterer of Choice</h2>
              <p>
                From the harbor views of San Diego Bay to the lively historic
                Gaslamp Quarter to Little Italy with its cozy cafes and
                international restaurants, downtown San Diego is a great place
                to hold an event. The Flavor Fam team of chefs has helped create
                many memorable experiences in the heart of the city. The
                possibilities are endless, and we love working with clients to
                help shape their vision and make it a reality.
              </p>
              <ButtonSolid
                as="button"
                modal="modal-contact"
...
export const query = graphql`
  {
    ...
    heroDesktop: file(relativePath: { eq: "cities/Downtown SD/1.0 Hero.jpg" }) {
      childImageSharp {
        gatsbyImageData(layout: FULL_WIDTH, placeholder: BLURRED, quality: 100)
      }
    }
    city: file(
      relativePath: { eq: "cities/Downtown SD/2.0 City Specific Content.jpg" }
    ) {
      childImageSharp {
        gatsbyImageData(layout: FULL_WIDTH, placeholder: BLURRED, quality: 100)
      }
