...
const Page = ({ data }) => {
  ...
  const appetizers = [
    {
      ...
      description: "seared lamb chop, rosemary, garlic, dill-mustard Shrimp ",
    },
    {
      name: "Lime Ceviche",
      description:
    ...
    {
      name: "Cantaloupe & Prosciutto Skewer",
      description: "cantaloupe, prosciutto, reduced balsamic, mint",
    },
    {
      name: "Cured Salmon Cucumber Roll Up",
      description: "cured salmon, lemon dill cream cheese, cucumber",
    },
    {
      name: "Duck Con fit Crostini",
      description:
  ...
  const salad = [
    {
      ...
      description: "butter lettuce, crouton, blistered tomato, shaved parmesan",
    },
    {
      name: "Watermelon Strawberry Salad",
      description:
        "arugula, watermelon, cucumber, feta, micro mint, lemon EVOO",
    },
    {
      name: "Beets & Burrata ",
      description:
        " roasted red beets, strawberry, burrata, greens, ginger balsamic",
    },
  ];
  ...
  const main = [
    {
      ...
      description:
        "Jidori airline breast, herbs, garlic, grilled peach & Hatch green chili glaze",
    },
    {
    ...
    {
      name: "Citrus Seabass",
      description: "local seabass, fresh citrus, apricot beurre blanc",
    },
    {
      name: "Lobster Tail",
      description: "butterflied lobster tail, lemon, butter, white wine",
    },
    {
  ...
  const starch = [
    ...
    {
      name: "Summer Corn Risotto",
      description:
        "summer corn, saffron, arborio, white wine, parmesan Reggiano",
    },
    {
  ...
  const dessert = [
    ...
    {
      name: "Cherry Galette ",
      description: "cherry compote, pie crust, vanilla ice cream",
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 className="text-white mb-0">Summer Dinner Party</h1>
      </HeroFullWidth>
...
export const query = graphql`
  {
    ...
    heroDesktop: file(
      relativePath: {
        eq: "menus/Summer Dinner Party Menu/1.0 Summer Dinner Party Hero Desktop.jpg"
      }
    ) {
      childImageSharp {
    ...
    heroMobile: file(
      relativePath: {
        eq: "menus/Summer Dinner Party Menu/1.0 Summer Dinner Party Hero Mobile.jpg"
      }
    ) {
      childImageSharp {
        gatsbyImageData(layout: FULL_WIDTH, placeholder: BLURRED, quality: 100)
