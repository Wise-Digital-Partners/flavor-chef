        ...
        <div className="container">
          <div className="grid md:grid-cols-2 items-center gap-y-10 md:gap-x-10 lg:gap-x-20">
            <div className="order-2 md:order-1">
              <h1>Palm Springs Catering</h1>
              <p>
                Experience the flavor infusion that will create an unforgettable
                experience for your guests. The Flavor Chef Catering ‘Flavor
                Fam’ brings chef-inspired, ingredient-focused food to your Palm
                Springs event.
              </p>
              <ButtonSolid
                as="button"
      ...
      <section className="bg-gray-50 relative pt-20 md:pt-32 pb-20 md:pb-32 mb-20 md:mb-32 overflow-hidden">
        ...
        <div className="container relative">
          <header className="max-w-3xl mx-auto text-center mb-12 md:mb-26">
            <h2>Palm Springs Full-Service Catering Company</h2>
            <p>
              ...
              extraordinary with our Palm Springs full-service catering company,
          ...
          <div className="grid md:grid-cols-2 items-center gap-y-10 md:gap-x-10 lg:gap-x-20">
            <div>
              <GatsbyImage
                ...
                alt="Palm Springs’ Caterer of Choice"
              />
            </div>
            <div>
              <h2>Palm Springs’ Caterer of Choice</h2>
              <p>
                From its divine desert scenery, to its extraordinary mid-century
                modern architecture, to its world-renowned golf courses, we love
                being your caterer of choice for Palm Springs. Our team of
                experienced chefs has created many memorable experiences in the
                desert city known for its celebrity influence and nicknamed
                ‘Hollywood’s Playground.’ The possibilities are endless, and we
                love working with clients to help shape their vision and make it
                a reality.
              </p>
              <ButtonSolid
                as="button"
...
export const query = graphql`
  {
    ...
    heroDesktop: file(
      relativePath: { eq: "cities/Palm Springs/1.0 Hero.jpg" }
    ) {
      childImageSharp {
        gatsbyImageData(
          layout: CONSTRAINED
    ...
    city: file(
      relativePath: { eq: "cities/Palm Springs/2.0 City Specific Content.jpg" }
    ) {
      childImageSharp {
        gatsbyImageData(
          layout: CONSTRAINED
